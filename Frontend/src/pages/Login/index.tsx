...
export const Login = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="bg-login-bg h-[80vh] bg-blend-multiply bg-gray-800 bg-cover bg-center flex flex-col justify-center items-center">
        ...
        <div className="bg-[#101010] mt-4 rounded-xl w-1/4 py-4">
          ...
          <div className="h-1 bg-gradient-to-r from-[#e74c3c] to-[#c0392b]"></div>
          <form onSubmit={sendAuth} className="p-4 flex flex-col justify-center items-center">
            <div className="w-[70%] mt-2 overflow-hidden rounded-md flex bg-white justify-between items-center">
              ...
              <input 
                ...
                required             
                className="w-full border-0 focus:border-b-4 focus:border-[#c0392b] focus:ring-0 dark:focus:border-zinc-300"/>
            </div>
            ...
            <button type="submit" className="w-[70%] rounded-md font-semibold mb-4 p-3 bg-gradient-to-r from-[#e74c3c] to-[#c0392b]">
              Entrar
            </button>
            {ErrorAuth ? ( 
      ...
      <div className="bg-[#070707] h-[20vh] text-white flex items-center flex-col p-6">
        ...
        <p className="text-xs">Erga Engenharia</p>    
        <img src={Logo} className="w-8 m-2"/>
      </div>
    </div>
  )
}
